...
const Support = () => {
  return (
    <div className="page-content page-content__support">
      ...
      <h3 className="heading-tertiary">Types of Support</h3>
      ...
      <h3 className="heading-tertiary">How to Contact Us:</h3>
      <div className="contact-us__para">
        <p className="heading-primary">
      ...
      <ul className="contact-us__para">
        <li className="heading-primary">Email: info@alphamuscle.in</li>
        <li className="heading-primary">Phone: +91-9109410160</li>
      </ul>
      <h3 className="heading-tertiary">Support Hours:</h3>
      <div className="contact-us__para">
        <p className="heading-primary">
      ...
      <ul className="contact-us__para">
        <li className="heading-primary">Monday to Friday: 10:30AM - 5:00PM</li>
      </ul>
      <h3 className="heading-tertiary">Response Time:</h3>
      <div className="contact-us__para">
        <p className="heading-primary">
      ...
      <h3 className="heading-tertiary">Feedback:</h3>
      <div className="contact-us__para">
        <p className="heading-primary">
      ...
      <h3 className="heading-tertiary">Thank You:</h3>
      <div className="contact-us__para">
        <p className="heading-primary">
