...
//         );
//         setSelectedFlavour(
//           data.flavours.flavourName && data.flavours.length > 0
//             ? data.flavours.flavourName[0]
//             : ""
//         );

//         console.log("Initialized size:", data.sizes[0]); // Debugging
//         console.log("Initialized flavour:", data.flavours.flavourName[0]); // Debugging
//       } catch (error) {
//         console.error("Error fetching product:", error);
//       }
//     };
...
//   const handleNextImage = () => {
//     setCurrentImageIndex((prevIndex) =>
//       prevIndex === product.flavours.images.length - 1 ? 0 : prevIndex + 1
//     );
//   };

//   const handlePreviousImage = () => {
//     setCurrentImageIndex((prevIndex) =>
//       prevIndex === 0 ? product.flavours.images.length - 1 : prevIndex - 1
//     );
//   };
...
//                   </button>
//                   <img
//                     src={product.flavours.images[currentImageIndex]}
//                     alt={product.name}
//                     className="single-product__image"
//                   />
//                   <button
...
//                 <div className="single-product__preview">
//                   <div className="single-product__thumbnails">
//                     {product.flavours.images.map((image, index) => (
//                       <img
//                         key={index}
//                         src={image}
//                         alt={`Thumbnail ${index}`}
...
//                   </>
//                 )}
//                 {product.flavours.flavourName &&
//                   product.flavours.flavourName.length > 0 && (
//                     <div className="flavour-selection">
//                       <label htmlFor="flavours" className="heading-tertiary">
//                         Flavours:
//                       </label>
...
//                         className="btn btn--green btn--dropdown"
//                       >
//                         {product.flavours.flavourName.map((flavour) => (
//                           <option key={flavour} value={flavour}>
//                             {flavour}
//                           </option>
//                         ))}
