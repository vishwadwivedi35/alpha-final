...
const PrivacyPolicy = () => {
  return (
    <div className="page-content page-content__privacy">
      ...
      <h3 className="heading-tertiary">Collection of Your Information:</h3>
      <div className="contact-us__para">
        <p className="heading-primary">
      ...
      <h3 className="heading-tertiary">Use of Your Information:</h3>
      <div className="contact-us__para">
        <p className="heading-primary">
      ...
      <div className="contact-us__para">
        <ul>
          <li className="heading-primary">To process transactions</li>
          <li className="heading-primary">
          ...
          <li className="heading-primary">To protect our website</li>
          <li className="heading-primary">
            To enforce our terms, conditions, and policies
          </li>
        </ul>
      </div>
      <h3 className="heading-tertiary">Shipping Policy:</h3>
      <div className="contact-us__para">
        <p className="heading-primary">
      ...
      <h3 className="heading-tertiary">Disclosure of Your Information:</h3>
      <div className="contact-us__para">
        <p className="heading-primary">
      ...
      <div className="contact-us__para">
        <ul>
          <li className="heading-primary">By Law or to Protect Rights</li>
          <li className="heading-primary">Third-Party Service Providers</li>
          <li className="heading-primary">Marketing Communications</li>
          <li className="heading-primary">Interactions with Other Users</li>
          <li className="heading-primary">Online Postings</li>
        </ul>
      </div>
    </div>
  );
